...
static NSString *LRRNationalCellIdfy = @"LRRNationalCellIdfy";

@interface LRRNationalViewCell ()<LRRNationalFieldDelegate>
...
@implementation LRRNationalViewCell
...
- (void)awakeFromNib {
    ...
    self.textField.nationalDelegate = self;
}
