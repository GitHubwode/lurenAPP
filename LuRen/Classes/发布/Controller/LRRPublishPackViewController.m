//
//  LRRPublishPackViewController.m
//  LuRen
//
...
@implementation LRRPublishPackViewController
...
{
    if (!_datasource) {
        _datasource = [LRRCustomInfoItem mj_objectArrayWithFilename:@"LRRPublishPackList.plist"];    }
    return _datasource;
}
