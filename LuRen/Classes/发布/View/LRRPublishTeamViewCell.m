...
static NSString *LRRPublishTeamCellIdfy = @"LRRPublishTeamCellIdfy";

@interface LRRPublishTeamViewCell()<LRRTeamFieldDelegate>
...
@implementation LRRPublishTeamViewCell
