...
- (void)configBottomToolBar {
    ...
    [_previewButton setTitleColor:LRRTitleTextColor forState:UIControlStateNormal];
    ...
    if (tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setTitleColor:LRRTitleTextColor forState:UIControlStateSelected];
        ...
        _originalPhotoLable.textColor = LRRTitleTextColor;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LRRLog(@"%zd - %zd - %zd - %zd",tzImagePickerVc.sortAscendingByModificationDate,indexPath.row,_showTakePhotoBtn,_models.count);
...
#define push @#clang diagnostic pop
        ...
        video.delegate = self;
         LRRBaseNavigationController*nav = [[LRRBaseNavigationController alloc] initWithRootViewController:video];
