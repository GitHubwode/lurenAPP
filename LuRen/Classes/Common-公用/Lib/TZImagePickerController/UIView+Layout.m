...
+ (void)showOscillatoryAnimationWithLayer:(CALayer *)layer type:(TZOscillatoryAnimationType)type{
    ...
    [self showOscillatoryAnimationWithLayer:layer animationScales:@[animationScale1, animationScale2]];
...
+ (void)showOscillatoryAnimationWithLayer:(CALayer *)layer animationScales:(NSArray<NSNumber *> *)scales{
    
    NSNumber *animationScale1 = scales.firstObject;
    NSNumber *animationScale2 = scales.lastObject;
