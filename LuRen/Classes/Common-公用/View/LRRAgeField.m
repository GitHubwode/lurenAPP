...
@interface LRRAgeField ()<UIPickerViewDataSource,UIPickerViewDelegate>
...
- (NSMutableArray *)provinces
{
    if (_provinces == nil) {
        // 保存模型
        _provinces = [NSMutableArray mj_objectArrayWithFilename:@"LRRAgeList.plist"];
...
- (void)ensureButtonAction{
    ...
    if ([self.ageDelegate respondsToSelector:@selector(ensureButtonClicked)]) {
        [self.ageDelegate ensureButtonClicked];
    }
