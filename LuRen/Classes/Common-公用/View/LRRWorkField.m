...
@interface LRRWorkField ()<UIPickerViewDataSource,UIPickerViewDelegate>
...
- (NSMutableArray *)provinces
{
    if (_provinces == nil) {
        // 保存模型
        _provinces = [NSMutableArray mj_objectArrayWithFilename:@"LRRWorkList.plist"];
...
- (void)ensureButtonAction{
    ...
    if ([self.workDelegate respondsToSelector:@selector(ensureButtonClicked)]) {
        [self.workDelegate ensureButtonClicked];
    }
