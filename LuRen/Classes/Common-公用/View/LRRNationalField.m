...
@interface LRRNationalField ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@implementation LRRNationalField
...
- (NSMutableArray *)provinces
{
    if (_provinces == nil) {
        // 保存模型
        _provinces = [NSMutableArray mj_objectArrayWithFilename:@"NationalList.plist"];
...
- (void)ensureButtonAction{
    ...
    if ([self.nationalDelegate respondsToSelector:@selector(ensureButtonClicked)]) {
        [self.nationalDelegate ensureButtonClicked];
    }
