...
@interface LRRCityField ()<UIPickerViewDataSource,UIPickerViewDelegate>
...
- (NSMutableArray *)provinces
{
    if (_provinces == nil) {
        // 保存模型
        _provinces = [NSMutableArray mj_objectArrayWithFilename:@"CityList.plist"];
...
- (void)ensureButtonAction{
    ...
    if ([self.cityDelegate respondsToSelector:@selector(ensureButtonClicked)]) {
        [self.cityDelegate ensureButtonClicked];
    }
